...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__54555){
var map__54556 = p__54555;
var map__54556__$1 = cljs.core.__destructure_map(map__54556);
var ast = map__54556__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54556__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54556__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__54557){
var map__54558 = p__54557;
var map__54558__$1 = cljs.core.__destructure_map(map__54558);
var child_ast = map__54558__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54558__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54558__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54558__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__54559 = idx;
var G__54559__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__54559,dispatch_key,parent_key):G__54559);
var G__54559__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__54559__$1,key,parent_key):G__54559__$1);
var G__54559__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__54559__$2,key,parent_key):G__54559__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__54559__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__54559__$3,child_ast));
} else {
return G__54559__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54560__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__54561){
var map__54562 = p__54561;
var map__54562__$1 = cljs.core.__destructure_map(map__54562);
var ast = map__54562__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54562__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54562__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,1602754347,null);

var map__54563 = app__$1;
var map__54563__$1 = cljs.core.__destructure_map(map__54563);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54563__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54563__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__54564 = cljs.core.deref(runtime_atom);
var map__54564__$1 = cljs.core.__destructure_map(map__54564);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54564__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__54566 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__54566__$1 = cljs.core.__destructure_map(map__54566);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54566__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__54570 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__54570__$1 = cljs.core.__destructure_map(map__54570);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54570__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__54573){
var map__54574 = p__54573;
var map__54574__$1 = cljs.core.__destructure_map(map__54574);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54574__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__54575_54586 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__54576_54587 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__54576_54587);
...
}),null)),null,1551370828,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__54575_54586);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__54577 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__54578 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__54578);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__54577);
}})], null);
}));
