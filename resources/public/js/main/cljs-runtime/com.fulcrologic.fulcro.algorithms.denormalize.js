 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__50081){
var vec__50082 = p__50081;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50082,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50082,(1),null);
var ref = vec__50082;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__50085){
var vec__50086 = p__50085;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50086,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50086,(1),null);
var ref = vec__50086;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__50089){
var map__50090 = p__50089;
var map__50090__$1 = cljs.core.__destructure_map(map__50090);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50090__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__50091,entity,state_map,parent_node,idents_seen){
var map__50092 = p__50091;
var map__50092__$1 = cljs.core.__destructure_map(map__50092);
var join_node = map__50092__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50092__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50092__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__50093,entity,state_map,idents_seen){
var map__50094 = p__50093;
var map__50094__$1 = cljs.core.__destructure_map(map__50094);
var join_node = map__50094__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50094__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__50095){
var map__50096 = p__50095;
var map__50096__$1 = cljs.core.__destructure_map(map__50096);
var node = map__50096__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50096__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__50097 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50097,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__50100 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__50100) : union_key__GT_query.call(null,G__50100));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__50101,current_entity,state_map,idents_seen){
var map__50102 = p__50101;
var map__50102__$1 = cljs.core.__destructure_map(map__50102);
var top_node = map__50102__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50102__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50102__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__50103 = nil_nodes;
var G__50103__$1 = (((G__50103 == null))?null:cljs.core.first(G__50103));
if((G__50103__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__50103__$1);
}
})());
} else {
return and__4251__auto__;
...
var G__50104 = result_node__$1;
var G__50104__$1 = (((G__50104 == null))?null:cljs.core.persistent_BANG_(G__50104));
if((G__50104__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__50104__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__50105 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__50105 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__50105,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__50106 = props;
var G__50106__$1 = (((G__50106 == null))?null:cljs.core.meta(G__50106));
if((G__50106__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__50106__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__50107 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__50108 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__50108);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__50107);
}});
/**
...
var map__50109 = cljs.core.meta(prior_props);
var map__50109__$1 = cljs.core.__destructure_map(map__50109);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50109__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50109__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
