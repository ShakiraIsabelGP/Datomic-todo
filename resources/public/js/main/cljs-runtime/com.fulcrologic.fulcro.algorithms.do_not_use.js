...
var expr__$1 = (function (){var G__50044 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__50044);
} else {
return G__50044;
}
})();
...
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__50045) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__50045));
} else {
return expr;
...
var len__4864__auto___50078 = arguments.length;
var i__4865__auto___50079 = (0);
while(true){
if((i__4865__auto___50079 < len__4864__auto___50078)){
args__4870__auto__.push((arguments[i__4865__auto___50079]));

var G__50080 = (i__4865__auto___50079 + (1));
i__4865__auto___50079 = G__50080;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq50046){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50046));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__50076 = query;
var G__50076__$1 = (((G__50076 == null))?null:cljs.core.meta(G__50076));
var G__50076__$2 = (((G__50076__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__50076__$1));
if((G__50076__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__50076__$2) : component_name_fn.call(null,G__50076__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,-1703003592,null);
} else {
}
