...
var map__54616 = app__$1;
var map__54616__$1 = cljs.core.__destructure_map(map__54616);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54616__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var raf_54621 = (((typeof requestAnimationFrame !== 'undefined'))?requestAnimationFrame:(function (p1__54618_SHARP_){
return com.fulcrologic.fulcro.algorithms.scheduling.defer(p1__54618_SHARP_,(16));
}));
/**
...
var map__54619 = app__$1;
var map__54619__$1 = cljs.core.__destructure_map(map__54619);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54619__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);
...
return (raf_54621.cljs$core$IFn$_invoke$arity$1 ? raf_54621.cljs$core$IFn$_invoke$arity$1(f) : raf_54621.call(null,f));
}
});
