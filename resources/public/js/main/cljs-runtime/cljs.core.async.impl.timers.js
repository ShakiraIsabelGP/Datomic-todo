...
var i_45881 = (self__.level + (1));
while(true){
if((i_45881 <= (new_level + (1)))){
(update[i_45881] = self__.header);

var G__45882 = (i_45881 + (1));
i_45881 = G__45882;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45883 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45883[i]));
} else {
x__$2.forward.push((((i < links_45883.length))?(links_45883[i]):null));
}

if((i < links_45883.length)){
(links_45883[i] = x__$2);
} else {
links_45883.push(x__$2);
}
...
var i_45885 = (0);
while(true){
if((i_45885 <= self__.level)){
var links_45886 = (update[i_45885]).forward;
if((x__$1 === (((i_45885 < links_45886.length))?(links_45886[i_45885]):null))){
(links_45886[i_45885] = (x__$1.forward[i_45885]));

var G__45887 = (i_45885 + (1));
i_45885 = G__45887;
continue;
} else {
var G__45888 = (i_45885 + (1));
i_45885 = G__45888;
continue;
}
} else {
...
var G__45890 = nx;
var G__45891 = (level__$1 - (1));
x = G__45890;
level__$1 = G__45891;
continue;
} else {
var G__45892 = x;
var G__45893 = (level__$1 - (1));
x = G__45892;
level__$1 = G__45893;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__45895 = nx;
var G__45896 = (level__$1 - (1));
x = G__45895;
level__$1 = G__45896;
continue;
} else {
var G__45897 = x;
var G__45898 = (level__$1 - (1));
x = G__45897;
level__$1 = G__45898;
continue;
}
