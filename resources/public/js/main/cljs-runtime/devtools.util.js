...
var len__4864__auto___42109 = arguments.length;
var i__4865__auto___42110 = (0);
while(true){
if((i__4865__auto___42110 < len__4864__auto___42109)){
args__4870__auto__.push((arguments[i__4865__auto___42110]));

var G__42111 = (i__4865__auto___42110 + (1));
i__4865__auto___42110 = G__42111;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__42084_42112 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__42085_42113 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__42086_42114 = true;
var _STAR_print_fn_STAR__temp_val__42087_42115 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__42086_42114);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__42087_42115);

try{var _STAR_print_level_STAR__orig_val__42088_42116 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42089_42117 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42089_42117);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42088_42116);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__42085_42113);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__42084_42112);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq42083){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42083));
}));
...
var new_formatters = current_formatters.filter((function (p1__42091_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__42091_SHARP_)));
}));
...
var G__42092_42118 = f;
var target__39607__auto___42119 = G__42092_42118;
if(cljs.core.truth_(target__39607__auto___42119)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42092_42118)].join(''),"\n","target__39607__auto__"].join('')));
}

(target__39607__auto___42119["toString"] = (function (){
...
var G__42093_42120 = "%c%s";
var G__42094_42121 = "color:transparent";
var G__42095_42122 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__42093_42120,G__42094_42121,G__42095_42122) : f.call(null,G__42093_42120,G__42094_42121,G__42095_42122));
...
var args__4870__auto__ = [];
var len__4864__auto___42123 = arguments.length;
var i__4865__auto___42124 = (0);
while(true){
if((i__4865__auto___42124 < len__4864__auto___42123)){
args__4870__auto__.push((arguments[i__4865__auto___42124]));

var G__42125 = (i__4865__auto___42124 + (1));
i__4865__auto___42124 = G__42125;
continue;
} else {
}
break;
...
var vec__42100 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42100,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42100,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__42126__delegate = function (add_fmt,add_args){
...
var G__42126 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__42127__i = 0, G__42127__a = new Array(arguments.length -  1);
while (G__42127__i < G__42127__a.length) {G__42127__a[G__42127__i] = arguments[G__42127__i + 1]; ++G__42127__i;}
  add_args = new cljs.core.IndexedSeq(G__42127__a,0,null);
} 
return G__42126__delegate.call(this,add_fmt,add_args);};
G__42126.cljs$lang$maxFixedArity = 1;
G__42126.cljs$lang$applyTo = (function (arglist__42128){
var add_fmt = cljs.core.first(arglist__42128);
var add_args = cljs.core.rest(arglist__42128);
return G__42126__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq42096){
...
var G__42099 = cljs.core.first(seq42096__$2);
var seq42096__$3 = cljs.core.next(seq42096__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42097,G__42098,G__42099,seq42096__$3);
}));
...
var seq__42103 = cljs.core.seq(features);
var chunk__42104 = null;
var count__42105 = (0);
var i__42106 = (0);
while(true){
if((i__42106 < count__42105)){
var feature = chunk__42104.cljs$core$IIndexed$_nth$arity$2(null,i__42106);
...
var G__42129 = seq__42103;
var G__42130 = chunk__42104;
var G__42131 = count__42105;
var G__42132 = (i__42106 + (1));
seq__42103 = G__42129;
chunk__42104 = G__42130;
count__42105 = G__42131;
i__42106 = G__42132;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__42103);
if(temp__5753__auto__){
var seq__42103__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42103__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__42103__$1);
var G__42133 = cljs.core.chunk_rest(seq__42103__$1);
var G__42134 = c__4679__auto__;
var G__42135 = cljs.core.count(c__4679__auto__);
var G__42136 = (0);
seq__42103 = G__42133;
chunk__42104 = G__42134;
count__42105 = G__42135;
i__42106 = G__42136;
continue;
} else {
var feature = cljs.core.first(seq__42103__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__42137 = cljs.core.next(seq__42103__$1);
var G__42138 = null;
var G__42139 = (0);
var G__42140 = (0);
seq__42103 = G__42137;
chunk__42104 = G__42138;
count__42105 = G__42139;
i__42106 = G__42140;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o42108 = temp__5751__auto__;
return (o42108["version"]);
} else {
return null;
}
})() == null);
