...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48284_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__48284_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48303_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48303_SHARP_)));
}),row));
});
...
var G__48360 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__48361 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__48360,G__48361) : expound.printer.format.call(null,G__48360,G__48361));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48362_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48362_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48363_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48363_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__48366(s__48367){
return (new cljs.core.LazySeq(null,(function (){
var s__48367__$1 = s__48367;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__48367__$1);
if(temp__5753__auto__){
var s__48367__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48367__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__48367__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__48369 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__48368 = (0);
while(true){
if((i__48368 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__48368);
cljs.core.chunk_append(b__48369,(function (){var iter__4652__auto__ = ((function (i__48368,row_idx,c__4650__auto__,size__4651__auto__,b__48369,s__48367__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__48366_$_iter__48373(s__48374){
return (new cljs.core.LazySeq(null,((function (i__48368,row_idx,c__4650__auto__,size__4651__auto__,b__48369,s__48367__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__48374__$1 = s__48374;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__48374__$1);
if(temp__5753__auto____$1){
var s__48374__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__48374__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__48374__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__48376 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__48375 = (0);
while(true){
if((i__48375 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__48375);
cljs.core.chunk_append(b__48376,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__48666 = (i__48375 + (1));
i__48375 = G__48666;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48376),expound$printer$multirow_$_iter__48366_$_iter__48373(cljs.core.chunk_rest(s__48374__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48376),null);
}
} else {
var col_idx = cljs.core.first(s__48374__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__48366_$_iter__48373(cljs.core.rest(s__48374__$2)));
}
} else {
return null;
}
...
});})(i__48368,row_idx,c__4650__auto__,size__4651__auto__,b__48369,s__48367__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__48368,row_idx,c__4650__auto__,size__4651__auto__,b__48369,s__48367__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48369),expound$printer$multirow_$_iter__48366(cljs.core.chunk_rest(s__48367__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48369),null);
}
} else {
var row_idx = cljs.core.first(s__48367__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__48367__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__48366_$_iter__48379(s__48380){
return (new cljs.core.LazySeq(null,(function (){
var s__48380__$1 = s__48380;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__48380__$1);
if(temp__5753__auto____$1){
var s__48380__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__48380__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__48380__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__48382 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__48381 = (0);
while(true){
if((i__48381 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__48381);
cljs.core.chunk_append(b__48382,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__48669 = (i__48381 + (1));
i__48381 = G__48669;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48382),expound$printer$multirow_$_iter__48366_$_iter__48379(cljs.core.chunk_rest(s__48380__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48382),null);
}
} else {
var col_idx = cljs.core.first(s__48380__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__48366_$_iter__48379(cljs.core.rest(s__48380__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__48367__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__48366(cljs.core.rest(s__48367__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48393_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__48393_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__48417 = via;
var G__48417__$1 = (((G__48417 == null))?null:cljs.core.last(G__48417));
if((G__48417__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__48417__$1);
}
})();
...
var seq__48421_48672 = cljs.core.seq(problems);
var chunk__48422_48673 = null;
var count__48423_48674 = (0);
var i__48424_48675 = (0);
while(true){
if((i__48424_48675 < count__48423_48674)){
var p_48676 = chunk__48422_48673.cljs$core$IIndexed$_nth$arity$2(null,i__48424_48675);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_48676) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__48677 = seq__48421_48672;
var G__48678 = chunk__48422_48673;
var G__48679 = count__48423_48674;
var G__48680 = (i__48424_48675 + (1));
seq__48421_48672 = G__48677;
chunk__48422_48673 = G__48678;
count__48423_48674 = G__48679;
i__48424_48675 = G__48680;
continue;
} else {
var temp__5753__auto___48681 = cljs.core.seq(seq__48421_48672);
if(temp__5753__auto___48681){
var seq__48421_48682__$1 = temp__5753__auto___48681;
if(cljs.core.chunked_seq_QMARK_(seq__48421_48682__$1)){
var c__4679__auto___48683 = cljs.core.chunk_first(seq__48421_48682__$1);
var G__48684 = cljs.core.chunk_rest(seq__48421_48682__$1);
var G__48685 = c__4679__auto___48683;
var G__48686 = cljs.core.count(c__4679__auto___48683);
var G__48687 = (0);
seq__48421_48672 = G__48684;
chunk__48422_48673 = G__48685;
count__48423_48674 = G__48686;
i__48424_48675 = G__48687;
continue;
} else {
var p_48688 = cljs.core.first(seq__48421_48682__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_48688) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__48689 = cljs.core.next(seq__48421_48682__$1);
var G__48690 = null;
var G__48691 = (0);
var G__48692 = (0);
seq__48421_48672 = G__48689;
chunk__48422_48673 = G__48690;
count__48423_48674 = G__48691;
i__48424_48675 = G__48692;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48420_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__48420_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__48471){
var vec__48472 = p__48471;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48472,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48472,(1),null);
var G__48475 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48475__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__48476 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48476,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48476,(1),null);
var G__48479 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48479__$1)].join('')));
...
var len__4864__auto___48698 = arguments.length;
var i__4865__auto___48699 = (0);
while(true){
if((i__4865__auto___48699 < len__4864__auto___48698)){
args__4870__auto__.push((arguments[i__4865__auto___48699]));

var G__48700 = (i__4865__auto___48699 + (1));
i__4865__auto___48699 = G__48700;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq48492){
var G__48493 = cljs.core.first(seq48492);
var seq48492__$1 = cljs.core.next(seq48492);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48493,seq48492__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48506_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__48506_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__48507_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__48507_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__48508){
var vec__48509 = p__48508;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48509,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48509,(1),null);
...
var _STAR_print_newline_STAR__orig_val__48512_48704 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__48513_48705 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__48514_48706 = true;
var _STAR_print_fn_STAR__temp_val__48515_48707 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__48514_48706);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__48515_48707);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__48513_48705);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__48512_48704);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48516_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__48516_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__48575 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__48577;
var lines = seq__48576__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48572_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48572_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__48587 = in$;
var seq__48588 = cljs.core.seq(vec__48587);
var first__48589 = cljs.core.first(seq__48588);
var seq__48588__$1 = cljs.core.next(seq__48588);
var k = first__48589;
var rst = seq__48588__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__48590 = show_valid_values_QMARK_;
var G__48591 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__48592 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__48590,G__48591,G__48592) : expound.printer.summary_form.call(null,G__48590,G__48591,G__48592));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__48733 = show_valid_values_QMARK_;
var G__48734 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__48735 = rst__$1;
show_valid_values_QMARK_ = G__48733;
form = G__48734;
in$ = G__48735;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__48593 = show_valid_values_QMARK_;
var G__48594 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__48595 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__48593,G__48594,G__48595) : expound.printer.summary_form.call(null,G__48593,G__48594,G__48595));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__48596 = show_valid_values_QMARK_;
var G__48597 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__48598 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__48596,G__48597,G__48598) : expound.printer.summary_form.call(null,G__48596,G__48597,G__48598));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__48599 = show_valid_values_QMARK_;
var G__48600 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__48601 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__48599,G__48600,G__48601) : expound.printer.summary_form.call(null,G__48599,G__48600,G__48601));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__48602 = show_valid_values_QMARK_;
var G__48603 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__48604 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__48602,G__48603,G__48604) : expound.printer.summary_form.call(null,G__48602,G__48603,G__48604));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48605_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48605_SHARP_)).length);
...
var map__48614 = problem;
var map__48614__$1 = cljs.core.__destructure_map(map__48614);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48614__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48614__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__48615 = opts;
var map__48615__$1 = cljs.core.__destructure_map(map__48615);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48615__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__48638 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__48639 = false;
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__48638);
}})();
var vec__48616 = cljs.core.re_find(regex,s);
...
var line = first__48618;
var first__48618__$1 = cljs.core.first(seq__48617__$1);
var seq__48617__$2 = cljs.core.next(seq__48617__$1);
var prefix = first__48618__$1;
var _more = seq__48617__$2;
