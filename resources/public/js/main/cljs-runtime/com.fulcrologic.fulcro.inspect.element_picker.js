...
var G__51410 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__51410,"id",id);

goog.dom.appendChild(document.body,G__51410);
...
var G__51411 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__51411,"id",id);

goog.dom.appendChild(document.body,G__51411);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51412_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__51412_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__51412_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__51421){
var map__51422 = p__51421;
var map__51422__$1 = cljs.core.__destructure_map(map__51422);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51422__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__51426 = target__$1;
if((G__51426 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__51426);
}
})();
...
var G__51446 = goog.dom.getParentElement(target__$1);
target__$1 = G__51446;
continue;
}
} else {
...
var G__51434_51447 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__51434_51447) : on_pick.call(null,G__51434_51447));
...
var state_map = (function (){var G__51436 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__51436__$1 = (((G__51436 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__51436));
if((G__51436__$1 == null)){
return null;
} else {
return cljs.core.deref(G__51436__$1);
}
})();
...
}catch (e51437){var _ = e51437;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__51439 = comp;
var G__51439__$1 = (((G__51439 == null))?null:com.fulcrologic.fulcro.components.react_type(G__51439));
if((G__51439__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__51439__$1);
}
}catch (e51438){var _ = e51438;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__51441 = comp;
var G__51441__$1 = (((G__51441 == null))?null:com.fulcrologic.fulcro.components.react_type(G__51441));
if((G__51441__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__51441__$1,state_map);
}
}catch (e51440){var _ = e51440;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51445__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
