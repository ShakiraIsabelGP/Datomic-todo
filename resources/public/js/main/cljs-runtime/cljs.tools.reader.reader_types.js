...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43917 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43917(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43918 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43918(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43930 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43930(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43931 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43931(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43932 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43932(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43933 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43933(reader);
}
});
...
var G__43941 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43942 = s.append(c);
c = G__43941;
s = G__43942;
continue;
}
