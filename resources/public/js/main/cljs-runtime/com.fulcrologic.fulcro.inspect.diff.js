...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__45450){
var vec__45451 = p__45450;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45451,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45451,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__45466){
var vec__45468 = p__45466;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45468,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45468,(1),null);
var temp__5751__auto__ = cljs.core.find(b,k);
if(cljs.core.truth_(temp__5751__auto__)){
var vec__45474 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45474,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45474,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__45477 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45477,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__45477;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__45481){
var map__45482 = p__45481;
var map__45482__$1 = cljs.core.__destructure_map(map__45482);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45482__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__45484){
var map__45485 = p__45484;
var map__45485__$1 = cljs.core.__destructure_map(map__45485);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45485__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__45503 = cljs.core.first(rem);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__45483_SHARP_){
var G__45506 = p1__45483_SHARP_;
var G__45507 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__45506,G__45507) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__45506,G__45507));
}));
} else {
